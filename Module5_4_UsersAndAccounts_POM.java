...
public class Module5_4_UsersAndAccounts_POM {
	public commonLib CommonLibref = new commonLib();
	public static String homePage;
	public String manageJurisdictionAccountsTitlePage;
...
//	private WebElement savePreLinkedStatus01;
	...
	public Module5_4_UsersAndAccounts_POM() {
	...
	public void LoginWithWCIIncAdmin() {
		...
		ObjectRepo.test.log(Status.PASS,"Step : PassWord entered successfully :" + prop.getProperty("WciIncAdminPassphrase"));
...
//		executor.executeScript("window.scrollBy(0,550)", RowsPerPage);
	...
	public void selectSetUpJurisdictionAccounts() throws InterruptedException {
...
//		homeOption.click();
//		driver.get().findElement(By.xpath("(//*[@class='MuiTypography-root MuiTypography-body1 css-1yfaah8'])[1]")).click();
	try {
		wait.until(ExpectedConditions.elementToBeClickable(homeOption));
		Actions action = new Actions(driver.get());
		action.moveToElement(homeOption).click(homeOption).build().perform();
	}
	catch(NoSuchElementException e)
	{
		wait.until(ExpectedConditions.elementToBeClickable(homeOption));
		...
		ObjectRepo.test.log(Status.PASS, "WCI Clicks on HOME Button");
	}
	}
...
//		System.out.println(edit);		
	...
	public void VerifyDetailsInTypeOfInstrument() {
		  wait.until(ExpectedConditions.visibilityOf(Batch1));		
			List<WebElement> List = driver.get().findElements(By.xpath("//*[@class='MuiChip-label MuiChip-labelSmall css-1pjtbja']"));
			int size2 = List.size();
			...
			System.out.println(element);
			 ...
			 ObjectRepo.test.log(Status.PASS, "Result Step 1--> The 'Type of instrument' field' got displayed with dropdown and pre-selected :\r\n"
			...
			boolean isClickable = CloseSign1.isSelected();
				        ...
				        ObjectRepo.test.log(Status.PASS, "Result Step 2--> The data in 'Type of instrument' field' is not Enabled/not getting deselected");
	  }
	...
	public void VerifyDetailsInTypeOfTransfer() {
		  String BatchText=Batch1.getText();
			...
			ObjectRepo.test.log(Status.PASS, "Result Step 1--> The 'Type of transfer' field' got  displayed with dropdown and pre-selected as Batch transfer");
			 ...
			 boolean isClickable = RemoveBatchOption1.isSelected();
		        ...
		        ObjectRepo.test.log(Status.PASS, "Result Step 2--> The data in 'Type of transfer' field'is not enabled and not getting  deselected");	
	  }
...
//		System.out.println(issuance);		
		...
		CommonLibref.scroll(rowsperpage, "scrollToBottomOFPage", "rowsperpage");
		wait.until(ExpectedConditions.elementToBeClickable(manageJurisdictionAccountspagesearch));		   
		CommonLibref.click(manageJurisdictionAccountspagesearch, "moveToElementClick", "manageJurisdictionAccountspagesearch");
...
//		wait.until(ExpectedConditions.elementToBeClickable(spaceOfDropdown));	
	...
	public void DeselectReplenishment() throws InterruptedException {
    	...
    	//CommonLibref.click(closeReplenishment, "moveToElementClick", "closeReplenishment-");
...
//		}
	...
	public void DisplayAccountNameOnEditJurisdictionAccountsPage() {
		List<WebElement> List = driver.get().findElements(By.xpath("//*[@class=\"MuiTypography-root MuiTypography-body1 css-o6vnld\"]"));
...
//		executor.executeScript("window.scrollBy(0,550)", RowsPerPage);
	...
	public void AccountNumberClick() {
		...
		Actions action = new Actions(driver.get());
		action.moveToElement(accountNumberXpath).click(accountNumberXpath).build().perform();
	...
	public void SelectPrelinkFromDropDown()  {
		...
		try {
		CommonLibref.click(searchFieldOfJurisdictionStatus, "seleniumClick", "Jurisdiction Satus field");
...
//			JurisdictionsTextBox1.sendKeys(Jurisdictionname1);
	...
	public void selectManageJurisdictionDetailsPage()  {
		...
		public void ScrollUptoJurisdictionAccounts() {
	    	...
	    	System.out.println("Page is scrolled till Jurisdiction Accounts");
	    }
		...
		public void AssertErrorMessage() {
			...
			Assert.assertEquals(errormsgforissuance, "There must be at least one Jurisdiction Account other than Issuance added to the Jurisdiction.");
		...
		public void ScrollUptoManageJurisdictionDetails() {
	    	...
	    	CommonLibref.scroll(scrollUptoManageJurisdictionDetails, "scrollToElement", "scrollUptoManageJurisdictionDetails");
...
//			ObjectRepo.test.log(Status.PASS, "Error message is displayed as- " + errormsgforNoissuance);
			Boolean errorMessage = driver.get().findElement(By.xpath("//*[contains(text(),'There must be an Issuance Account added to the Jurisdiction.')]"))
					.isDisplayed();
		...
		public void AssertErrorMessageForPurchaseLimits() {
			...
			Boolean errorMessage1 = driver.get().findElement(By.xpath("//*[contains(text(),'Please update the Purchase Limit parameter to Value as per linkage rules.')]"))
					.isDisplayed();
...
//			System.out.println("The request to change the status of Automation Test One to Pre-Linked status has been submitted successfully");
		...
		public void ScrollUptoJurisdictionRequestandStatusChangeHistory() {
	    	wait.until(ExpectedConditions.visibilityOf(jurisdictionStatusChangeHistoryTable));	
	    	//CommonLibref.scroll(jurisdictionStatusChangeHistoryTable, "scrollToBottomOFPage", "Jurisdiction Request and Status Change History");
	    	CommonLibref.scroll(rowsperpage, "scrollToBottomOFPage", "rowsperpage");
	    }
...
//			ObjectRepo.test.log(Status.PASS, "Observe Cancelled Proposed status button");
		...
		public void ClickOnCancelProposeBtn() {
			...
			System.out.println("The 'cancel proposed status' popup should get displayed with 'No' and 'Cancel status' button ");
			ObjectRepo.test.log(Status.PASS, "The 'cancel proposed status' popup should get displayed with 'No' and 'Cancel status' button ");
			}
...
//			System.out.println("Click on Login button");
			...
			ObjectRepo.test.log(Status.PASS,"Step : PassWord entered successfully :" + prop.getProperty("JSASeededUserPassphrase1"));
			System.out.println("PassWord entered successfully");
			CommonLibref.click(checkBoxRememberMe, "seleniumClick", "checkBoxRememberMe");
			CommonLibref.click(btnLogin, "seleniumClick", "btnLogin");
			ObjectRepo.test.log(Status.PASS, "Step : Click on Login button ");
...
//	    }
		...
		public void VerifyTheSuccesMessageForOnboardingToPreLinkedStatus()  {
			...
			ObjectRepo.test.log(Status.PASS, "Message displayed as -" + successMessage);
			System.out.println("Message displayed as -" + successMessage);
			Boolean proposedForPreLinkedStatus = driver.get().findElement(By.xpath("//*[contains(text(),'The request to change the status')]"))
					.isDisplayed();
...
//			List<String> Instruments = new ArrayList<>();
		...
		public void VerifyManageJurisdictionAccountspageAfterCancelProposed() {
			...
			ObjectRepo.test.log(Status.PASS, "Step :More Actions option should get enabled on Manage Jurisdiction Accounts page to add Jurisdiction accounts again");
			System.out.println("More Actions option should get enabled on Manage Jurisdiction Accounts page to add Jurisdiction accounts again" );
			}
		...
		public void VerifyAddNewAccountBtn() {
			String Btn = addNewActBtnOnDetailsPage.getText();
			Assert.assertEquals(Btn, "ADD NEW ACCOUNT");
			System.out.println("Add New Account button should get enabled on Manage Jurisdiction Details page to add Jurisdiction accounts again" + Btn);
			ObjectRepo.test.log(Status.PASS,"Add New Account button should get enabled on Manage Jurisdiction Details page to add Jurisdiction accounts again" + Btn);	
		}
		...
		public void AssertQuickActionsOnInitialUsersPage () {
			wait.until(ExpectedConditions.visibilityOf(quickActionsOnManageInitialUsers));
			String QuickActionsTitle = quickActionsOnManageInitialUsers.getText();
			Assert.assertEquals(QuickActionsTitle, "Quick Actions");
			System.out.println("Quick Actions should get displayed" + QuickActionsTitle);
			ObjectRepo.test.log(Status.PASS, "Quick Actions should get displayed" + QuickActionsTitle);
		}
